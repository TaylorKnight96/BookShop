...
public class GUIcreator
{
    ...
    public void setSubTotal(ArrayList<BookInfo> order)
    {
        double subtotal;
        double total = 0;
        double discount = 0;
    ...
    public void showViewOrderDialog(ArrayList<BookInfo> orderList)
    {
        double subtotal = 0;
        double discount = 0;
        double total = 0;
    ...
    public void showFinishDialog(int numItems, ArrayList<BookInfo> orderList, double subTotal, String strDate)
    {
        double subtotal = 0;
        double discount = 0;
        double total = 0;
